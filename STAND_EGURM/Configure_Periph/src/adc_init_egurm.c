...
void AdcRcuConfig(void)
{
	...
	rcu_periph_clock_enable(ADC_EGURM_DPR_RCU_GPIO);
	/* enable ADC clock */
...
void AdcGpioConfig(void)
{
	...
	gpio_init(ADC_EGURM_DPR_GPIO, GPIO_MODE_AIN, GPIO_OSPEED_MAX, ADC_EGURM_DPR1_GPIO_PIN);
	gpio_init(ADC_EGURM_DPR_GPIO, GPIO_MODE_AIN, GPIO_OSPEED_MAX, ADC_EGURM_DPR2_GPIO_PIN);
	gpio_init(ADC_EGURM_DPR_GPIO, GPIO_MODE_AIN, GPIO_OSPEED_MAX, ADC_EGURM_DPR3_GPIO_PIN);
	gpio_init(ADC_EGURM_DPR_GPIO, GPIO_MODE_AIN, GPIO_OSPEED_MAX, ADC_EGURM_DPR4_GPIO_PIN);
}
...
void AdcConfig(void)
{
	...
	adc_regular_channel_config(ADC_EGURM_ADC, 6, ADC_EGURM_DPR1_ADC_CHANNEL, ADC_SAMPLETIME_7POINT5);
	adc_regular_channel_config(ADC_EGURM_ADC, 7, ADC_EGURM_DPR2_ADC_CHANNEL, ADC_SAMPLETIME_7POINT5);
	adc_regular_channel_config(ADC_EGURM_ADC, 8, ADC_EGURM_DPR3_ADC_CHANNEL, ADC_SAMPLETIME_7POINT5);
	adc_regular_channel_config(ADC_EGURM_ADC, 9, ADC_EGURM_DPR4_ADC_CHANNEL, ADC_SAMPLETIME_7POINT5);
